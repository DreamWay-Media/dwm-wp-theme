...
<section class="header-slider-wrap homepage-slider-wrap">
  <svg style="display:none;">
    <symbol viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" id="icon-star">
      <path d="M24 0L27.2244 20.7756L48 24L27.2244 27.2244L24 48L20.7756 27.2244L0 24L20.7756 20.7756L24 0Z" fill="white" class="parallax-star" />
    </symbol>
  </svg>
  <?php
  ...
  <section class="slider-main-wrap homepage-hero">
    ...
    <div class="parallax-container">
      <svg class="icon parallax-svg" style="left: 25%; Top: 25%">
        <use xlink:href="#icon-star"></use>
      </svg>

      <svg class="icon parallax-svg" style="left: 50%; Top: 50%">
        <use xlink:href="#icon-star"></use>
      </svg>

      <svg class="icon parallax-svg" style="left: 75%; Top: 75%">
        <use xlink:href="#icon-star"></use>
      </svg>
    </div>
    <!-- parallax -->
...
<?php endif; ?>
<!--content-->
<section class="content-main-wrap content-home-wrap">
              ...
              <li class="col-md-4">
                <div class="listing-featured-wrap" data-aos="fade-up">
                  <a href="<?php echo esc_url(get_the_permalink()); ?>">
                    <div class="listing-featured-wrap-image home-featured" style="background: url(<?php echo $thumbnail_url; ?>) no-repeat top;"></div>
                  </a>
      ...
      <div class="featured-blog-heading-wrap">
        <div class="row">
          <div data-aos="fade-up" class="col-md-6">
            <h2><?php echo esc_html($featured_blog_title); ?></h2>
          </div>
          <div data-aos="fade-left" class="col-md-6 mt-5 mt-md-0">
            <p><?php echo esc_html($featured_blog_description) ?></p>
          </div>
        </div>
      </div>
      <ul class="row">
